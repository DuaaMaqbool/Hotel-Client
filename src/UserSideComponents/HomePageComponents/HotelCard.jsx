...
//   return (
//     <Link to={'/rooms/'+ room._id} onClick={()=> scrollTo(0,0)} key={room._id} className='relative max-w-70 w-full rounded-xl overflow-hidden bg-white text-gray-500/90 shadow-[0px_4px_4px_rgba(0,0,00,0.05)]'>
...
// const HotelCard = ({ room, index }) => {
//   return (
//     <Link to={'/rooms/' + room._id} onClick={() => scrollTo(0, 0)} className="relative max-w-xs w-full bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300"
// >
//       {/* Image wrapper */}
...
//             <span className="text-lg font-semibold">${room.pricePerNight}</span>/night
//           </p>

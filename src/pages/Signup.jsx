...
const Signup = () => {
  ...
  useEffect(() => {
    ...
    if (formData.username.length > 0 && (formData.username.length < 4 || formData.username.length > 20)) {
    ...
    if (formData.password.length > 0 && (formData.password.length < 6 || formData.password.length > 20)) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (Object.values(errors).some((err) => err) || !formData.username || !formData.email || !formData.password) {
